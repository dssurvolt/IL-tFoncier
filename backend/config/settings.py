...
ALLOWED_HOSTS = ['*'] # À restreindre en prod: ['ilotfoncier.com', 'www.ilotfoncier.com', 'ilotfoncier.onrender.com']
...
# Important pour les environnements proxysés (cloud IDE, tunnels, Render)
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'sobaberakib4@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'msfxtjbvpyunzwti')
